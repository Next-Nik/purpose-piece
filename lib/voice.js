...
// Shown to user as Phase 2 completes and Phase 3 agent opens
const PHASE3_TRANSITION = `The signal is clear enough to work with.

What follows reflects how you tend to move when something requires direction — particularly under strain or ambiguity. It may feel sharper than what came before.
...
const PHASE_LABELS = {
  ...
  "2-fork":       "Clarifying Signal",
  "2-domain":     "Clarifying Signal",
  "2-scale":      "Clarifying Signal",
  "3-handoff":    "Clarifying Signal",
  3:              "Recognition",
