...
// ─── Welcome ──────────────────────────────────────────────────────────────────
const WELCOME = `Welcome. We're here to help you see where you fit in building the future we want to live into.

Three quick questions to get a signal on your pattern. Then we'll confirm it fits.

No right answers. Pick what's true in your actual life — not what sounds impressive.`;
...
const CLARIFICATIONS = {
  ...
  ambiguousMultiple: "You named more than one. If you had to choose only one — which survives?"
};
