...
// Maker vs Architect pressure fork — triggered when scoring is close between the two
const MAKER_ARCHITECT_FORK = {
  id: "p1_fork_maker_architect",
  phase: "1-fork",
  text: "When you see chaos, which is the stronger pull — ship something fast that moves the situation, or install a structure so the right things can keep moving without you?",
  inputType: "multiple_choice",
  options: [
    { id: "a", text: "Ship something fast — motion creates clarity.", archetype: "maker" },
    { id: "b", text: "Install a structure — the right architecture prevents the chaos from recurring.", archetype: "architect" }
  ]
};
...
const PHASE_2_QUESTIONS = {
  recentBehavior: {
    id: "p2_behavior",
    phase: 2,
    text: "What have you been working on or paying attention to lately — in your work, your community, or anything else you're invested in?",
    inputType: "free_text"
  },
  ...
  scale: {
    ...
    inputType: "multiple_choice",
    options: [
      { id: "a", text: "People and places I know directly — my neighbourhood, my community, face-to-face.", scale: "local" },
      { id: "b", text: "My region — the watershed, the city, the bioregion I'm part of.", scale: "bioregional" },
      { id: "c", text: "International, cross-border — planetary scale challenges and systems.", scale: "global" },
      { id: "d", text: "Intergenerational — working for people not yet born, thinking in decades or centuries.", scale: "civilizational" }
    ]
  }
};
