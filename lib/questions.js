...
const questions = [
...

  {
    ...
    // Key distinction: Connectors orient toward the person; Explorers orient toward the territory.
    // Both are outward-facing and socially active — but their primary drive differs.
    ...
    options: [
      ...
      {
        id: "b",
        text: "I've been thinking about what they said — the idea or angle was the interesting part",
