...
const PHASE_1_QUESTIONS = [
  {
    ...
    options: [
      ...
      { id: "g", text: "Figure out why the structure failed — then rebuild it so the chaos can't recur.", archetype: "architect" }
    ]
  },

  {
    ...
    inputType: "multiple_choice",
    options: [
      { id: "a", text: "I go looking for how others have solved this — in different contexts, different fields.", archetype: "explorer" },
      { id: "b", text: "I figure out what's at risk if this keeps being ignored and say so clearly.", archetype: "guardian" },
      { id: "c", text: "I map the structural reason nobody owns it — then redesign the conditions so it gets owned.", archetype: "architect" },
      { id: "d", text: "I observe it for longer — most unattended things are telling you something if you watch them.", archetype: "sage" },
      { id: "e", text: "I start handling the parts that aren't getting handled — quietly, without making it a production.", archetype: "steward" },
      { id: "f", text: "I find out who else has noticed and whether there's energy to do something about it together.", archetype: "connector" },
      { id: "g", text: "I start thinking about what a proper solution would look like and sketch it out.", archetype: "maker" }
    ]
  },

  {
    ...
    inputType: "multiple_choice",
    options: [
      { id: "a", text: "Making sure the right people stay in contact when this ends.", archetype: "connector" },
      { id: "b", text: "What this project revealed about how this kind of work actually functions — the deeper pattern.", archetype: "sage" },
      { id: "c", text: "What this whole thing learned that should be documented and taken somewhere.", archetype: "explorer" },
      { id: "d", text: "The structural questions nobody's named yet: who holds what, where does it live, what process carries it forward.", archetype: "architect" },
      { id: "e", text: "What needs to be protected — what shouldn't be lost even if the project is gone.", archetype: "guardian" },
      { id: "f", text: "What could be carried forward, repurposed, or built into something new.", archetype: "maker" },
      { id: "g", text: "Making sure the handoffs are clean — nothing important falls through the gap.", archetype: "steward" }
    ]
  }
];
...
const PHASE_2_QUESTIONS = {
  ...
  domain: {
    ...
    phase: "2-domain",
    label: "Domain",
    setup: "Where do you feel most drawn?",
    inputType: "multiple_choice",
    options: [
      { id: "a", text: "Human development — How people grow, learn, and become capable.", domain: "human_being" },
      { id: "b", text: "Social structure — How we organise, coordinate, and govern together.", domain: "society" },
      { id: "c", text: "Living systems — Ecology, biology, and the health of the natural world.", domain: "nature" },
      { id: "d", text: "Tools and infrastructure — Technology, systems, and the built environment.", domain: "technology" },
      { id: "e", text: "Economics and resources — Money, incentives, and material flows.", domain: "finance" },
      { id: "f", text: "Preservation — What must be protected, remembered, or carried forward.", domain: "legacy" },
      { id: "g", text: "Vision and imagination — Shared direction, narrative, and long-term possibility.", domain: "vision" }
    ]
  },
  ...
  scale: {
    ...
    phase: "2-scale",
    label: "Scale",
    setup: "Think of a real situation in that domain. What is the natural scope of your attention there?",
    inputType: "multiple_choice",
    options: [
      { id: "a", text: "People you can name — Specific individuals. Direct relationships.", scale: "local" },
      { id: "b", text: "A place you can stand in — A neighbourhood, city, or region — somewhere tangible.", scale: "bioregional" },
      { id: "c", text: "Systems that cross borders — Networks or institutions that move beyond one place.", scale: "global" },
      { id: "d", text: "What carries forward — Patterns or conditions that shape what comes next.", scale: "civilisational" }
    ]
  }
